...
- `/home/nicolas/hetzner-gateway/nginx/conf.d/11-solid-mcp.conf` — new, separate repo. TLS vhost for `solid-mcp.nicolasdb.eu`, `access_log off` (AC3), no IP allowlist yet (AC5/Task 5).
